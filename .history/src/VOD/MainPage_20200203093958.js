...
import { Card, Col, FormGroup, Row, Button, Collapse, Nav, NavItem, NavLink, Navbar, NavbarToggler } from "reactstrap";
    ...
    return (
      <div>
        <Navbar style={{ backgroundColor: "#6E918C" }}>
          ...
          <Nav style={{ justifyContent: 'space-around', backgroundColor: "#6E918C" }}>
            <NavItem>
              <NavbarToggler style={{ color: "#F5FFFD" }} onClick={this.toggleVod}>Vod Form</NavbarToggler>
            </NavItem>
            <NavItem>
              <NavbarToggler style={{ color: "#F5FFFD" }} onClick={this.toggleBtv}>Btv Form</NavbarToggler>
            </NavItem>
            <NavItem>
              <NavbarToggler style={{ color: "#F5FFFD" }}>Uploaded XML</NavbarToggler>
            </NavItem>
          </Nav>
