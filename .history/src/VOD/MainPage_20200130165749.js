    ...
    return (
      <div>
        ...
        <Row style={{ borderColor: "hrey", borderwidth: "3%" }}>
          <Col >
            <Button color="info" onClick={this.toggleVod} style={{ marginBottom: '1rem' }}>Toggle</Button>
          ...
          <Col >
            <Button color="info" onClick={this.toggleBtv} style={{ marginBottom: '1rem' }}>Toggle</Button>
