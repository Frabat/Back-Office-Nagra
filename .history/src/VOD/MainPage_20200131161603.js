  ...
  render() {
    ...
    return (
      <div >
        ...
        <Typography value={this.value} index={0}>
          Item One
</Typography>
        <Typography value={this.value} index={1}>
          Item Two
</Typography>
        <Typography value={this.value} index={2}>
          Item Three
</Typography>
        {/* <Typography
          ...
          id={`scrollable-auto-tabpanel-${this.index}`}
          aria-labelledby={`scrollable-auto-tab-${this.index}`}
          {...this.other}
        >
